	...
	<body>
			...
			<section class="row col-lg-offset-1 col-lg-10 col-xs-12">
				...
				<article class="presentation">
					<h1 class="pull-right">JE REALISE vos portraits en exterieur ou en studio </h1>
					<p class="pull-right">Portrait Femme, Homme, Enfant, Couple, Famille, Grossesse, Nouveau-né, Groupe...</p>
					<img src="images/portrait/portrait.jpg" class="hidden-xs col-lg-12">
				</article>
